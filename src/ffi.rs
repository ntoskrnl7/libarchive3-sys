...
extern "C" {
    ...
    pub fn archive_read_set_read_callback(
        arg1: *mut Struct_archive,
        arg2: *mut ::std::option::Option<extern "C" fn() -> ssize_t>,
    ) -> c_int;
    pub fn archive_read_set_seek_callback(
        arg1: *mut Struct_archive,
        arg2: *mut ::std::option::Option<extern "C" fn() -> i64>,
    ) -> c_int;
    ...
    pub fn archive_read_data(arg1: *mut Struct_archive, arg2: *mut c_void, arg3: size_t)
        -> ssize_t;
